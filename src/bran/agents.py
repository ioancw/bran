...
ORCHESTRATOR = Agent(
    ...
    system_prompt=(
        ...
        "  `mcp__bran__get_run_result` once they finish — bran triggers the "
        "  synthesis turn automatically when all runs complete, even if the "
        "  user has left (they can also ask 'synthesise those' anytime); merge "
